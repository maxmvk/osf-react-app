    ...
    return (
        <footer className={styles.footer}>
            ...
            <div className={styles.footerContainerMobile}>
                <div className={styles.copyright}>© Copyright {year}.<br />All Rights Reserved.</div>
                <div onClick={() => { props.toogleIsContactOpen(!props.isContactOpen) }} className={styles.title}>
                    CONTACT
                    {props.isContactOpen? <span>▲</span>: <span>▼</span>}
                </div>
                {
                    props.isContactOpen?
                    <ul className={styles.columnG}>
                        <li>Headquarters:<br /> 5600, Blvd. des Galeries, Bur 530 Québec, Québec G2K 2H6</li>
                        <li><a href="mailto:contact@osf-global.com">contact@osf-global.com</a></li>
                        <li><a href="tel:+18885484344">+1 (888) 548-4344</a></li>
                    </ul>
                ...
                <div onClick={() => { props.toogleIsCategoriestOpen(!props.isCategoriestOpen) }} className={styles.titleM}>
                    CATEGORIEST
                    {props.isCategoriestOpen? <span>▲</span>: <span>▼</span>}
                </div>
                {
                    props.isCategoriestOpen?
                    <ul className={styles.column}>
                        <li><NavLink to="/not-found-404" >Alcohol</NavLink></li>
                        <li><NavLink to="/not-found-404" >Art</NavLink></li>
                        <li><NavLink to="/not-found-404" >Books</NavLink></li>
                ...
                <div onClick={() => { props.toogleIsAboutOpen(!props.isAboutOpen) }} className={styles.titleM}>
                    ABOUT
                    {props.isAboutOpen? <span>▲</span>: <span>▼</span>}
                </div>
                {
                    props.isAboutOpen?
                    <ul className={styles.column}>
